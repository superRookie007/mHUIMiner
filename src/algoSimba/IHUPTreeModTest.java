 ...
 * The tree is ordered based on item frequency in descending order.
 * The tree will be more compressed than the tree ordered based on TWU
 * 
...
public class IHUPTreeModTest extends IHUPTreeMod{
...
//	private Map<Integer, Node> mapItemLastNode = new HashMap<Integer, Node>();

	public IHUPTreeModTest() {
...
//	}
	 ...
	 * 
	 * @param mapItemToFq
	 *            the frequency of each item (key: item, value: frequency)
	 */
	@Override
	void createHeaderList(final Map<Integer, Integer> mapItemToFq) {
		...
		Collections.sort(headerList, new Comparator<Integer>() {
			public int compare(Integer id1, Integer id2) {
				// compare the Utility
				int compare = mapItemToFq.get(id2) - mapItemToFq.get(id1);
